...
val_files_num = 146
test_files_num = 200
voc_annotations = 'C:/Users/index/Desktop/vedai/VOC/Annotations/'  #remember to modify the path
...
def convert(xml_files, json_file):
    ...
    for xml_file in xml_files:
        ...
        for obj in get(root, "object"):
            ...
            xmins = float(get_and_check(bndbox, "xmin", 1).text) - 1
            ymins = float(get_and_check(bndbox, "ymin", 1).text) - 1
            xmaxs = float(get_and_check(bndbox, "xmax", 1).text)
            ymaxs = float(get_and_check(bndbox, "ymax", 1).text)
            ...
            ann = {
                ...
                "id": bnd_id,
                "ignore": 0,
                "segmentation": [[xmins, ymins, xmins, ymaxs, xmaxs, ymaxs, xmaxs, ymins]],
            }
